          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="prose text-gray-600 text-sm space-y-3">
                <p>
                  The Bilka 150/100 half round system is designed for larger properties and areas
                  with higher rainfall. With a 150mm gutter width and 100mm downpipes, it handles
                  significantly more water volume than the 125/90 system.
                </p>
                <p>
                  Ideal for properties with roof areas exceeding 80m², commercial buildings, or
                  locations in high-rainfall regions of the UK.
                </p>
                <p>
                  Like the 125/90 system, it is manufactured from 0.6mm steel with your choice of
                  Glossy PE, Matt PE or Magnelis ZM310 coatings.
                </p>
              </div>
            </div>
            <div>
              ...
              <dl className="space-y-3 text-sm">
                {[
                  ...
                  ["Downpipe Diameter", "100mm"],
                  ["Material Thickness", "0.6mm"],
                  ["Material", "Bilka Steel"],
                  ["Gutter Lengths", "2m & 4m"],
                  ["Downpipe Lengths", "2m & 3m"],
                  ["Glossy Colours", "10 RAL options"],
                  ["Matt Colours", "7 RAL options"],
                  ["Magnelis", "Natural zinc finish"],
                ].map(([label, value]) => (
