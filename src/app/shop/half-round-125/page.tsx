          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="prose text-gray-600 text-sm space-y-3">
                <p>
                  The Bilka 125/90 half round system is the standard residential guttering solution,
                  suitable for most UK homes with roof areas up to approximately 80m².
                </p>
                <p>
                  Manufactured from 0.6mm steel with your choice of Glossy PE, Matt PE or Magnelis
                  ZM310 coatings, this system offers far superior longevity compared to plastic
                  alternatives.
                </p>
                <p>
                  The complete system includes gutters, downpipes, brackets, angles, stop ends, outlets
                  and all necessary fittings for a professional installation.
                </p>
              </div>
            </div>
            <div>
