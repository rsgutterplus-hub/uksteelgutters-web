...
const halfRound125Products: Product[] = [
  {
    ...
    features: ["125mm width", "0.6mm Bilka steel", "Half round profile", "Available in 2m & 3m lengths", "10 Glossy & 5 Matt RAL colours"],
  ...
  {
    id: "hr125-branch-pipe",
    name: "Branch Pipe 90mm",
    slug: "branch-pipe-90",
    system: "125/90",
    range: "Glossy",
    ...
    drawing: "/technical-drawings/schita_tehnica_bilka_ramificatie_90.pdf",
    price: "From £9.80",
    unitPrice: 9.80,
    unit: "each",
    category: "Downpipes",
...
const halfRound150Products: Product[] = [
  {
    ...
    features: ["150mm width", "0.6mm Bilka steel", "Half round profile", "Available in 2m & 3m lengths", "10 Glossy & 5 Matt RAL colours"],
    image: "/images/products/gutter-7011-glossy.jpg",
  ...
  {
    id: "hr150-branch-pipe",
    name: "Branch Pipe 100mm",
    slug: "branch-pipe-100",
    system: "150/100",
    range: "Glossy",
    ...
    image: "/images/products/branch-pipe-7016-glossy.jpg",
    drawing: "/technical-drawings/schita_tehnica_bilka_ramificatie_100.pdf",
    price: "From £11.50",
    unitPrice: 11.50,
    unit: "each",
    category: "Downpipes",
