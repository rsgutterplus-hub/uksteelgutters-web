...
const halfRound125Products: Product[] = [
  ...
  },
  {
    ...
    name: "Adjustable Hook 125mm",
    slug: "hook-adjustable-125",
    system: "125/90",
    range: "Glossy",
  ...
  },
  {
    ...
    system: "125/90",
    range: "Glossy",
    description: "Side mounted rafter bracket for securing the 125mm half round gutter directly to the rafter. Used where standard fascia hooks cannot be fitted.",
...
const halfRound150Products: Product[] = [
  ...
  },
  {
    ...
    name: "Adjustable Hook 150mm",
    slug: "hook-adjustable-150",
    system: "150/100",
    range: "Glossy",
  ...
  },
  {
    ...
    system: "150/100",
    range: "Glossy",
    description: "Side mounted rafter bracket for securing the 150mm half round gutter directly to the rafter. Used where standard fascia hooks cannot be fitted.",
